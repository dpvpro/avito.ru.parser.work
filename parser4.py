...
def parse(html):
    ...
    # print work_item
    # desc = work_item.find_all('h3')
    # ".encode('utf-8')" нужен для правильной интерпретации unicode
    # print desc[0].a.text.encode('utf-8')
    desc = work_item.find_all('div', class_='description')
    # print desc
    data = []
    for item in desc:
...
def main():
    ...
    projects.extend(parse(get_html(BASE_URL + "?p=%d" % 26)))
